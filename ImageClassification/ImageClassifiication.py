...
"""
This code uses deep learning networks to classify pictures of items
from a shop store.
source: https://www.youtube.com/watch?v=j6eGHROLKP8&list=PL37GDLKLDPutXC_IOotEuzl3KOulIGwGf&index=3&t=14s&ab_channel=RingaTech
"""
